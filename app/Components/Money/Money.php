...
namespace IVSales\Components\Money;

use IVSales\Exceptions\DifferentCurrencies;
use IVSales\Exceptions\ImpossibleSubtracts;

/**
 * Class Money
 * @package IVSales\Components\Money
...
class Money
{
     ...
     * @param $arguments
     * @return Money
     * @throws \IVSales\Exceptions\UnknownCurrency
     */
